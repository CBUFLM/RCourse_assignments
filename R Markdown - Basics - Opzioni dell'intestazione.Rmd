...
In questo caso è stata aggiunta l'opzione `toc`, _(table of content)_, con valore "TRUE": abbiamo appena abilitato la visualizzazione di un indice per il nostro file.  
...
[Qualche info sulla libreria _knitr_](https://yihui.name/knitr/)  
[Approfondimenti su _knitr_ ed RStudio](http://kbroman.org/knitr_knutshell/pages/Rmarkdown.html)  
