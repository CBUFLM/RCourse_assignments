...
<id="f3">3.</id> Linguaggio basato su marcatori _(tags)_, serve a rappresentare la struttura di un testo: fa capire alla macchina qual è il titolo principale, quali sono gli elenchi, le tabelle e così via utilizzando i tags. Checché ne possiate pensare, markdown è uno dei linguaggi più _**semplici**_.